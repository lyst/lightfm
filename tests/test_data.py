...
def test_build_features():
    ...
    assert np.all(user_features.todense() ==
                  np.array([list(range(users))] * users))
    ...
    assert np.all(item_features.todense() ==
                  np.array([list(range(items))] * items))
